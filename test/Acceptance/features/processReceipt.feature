Feature: Process a receipt once a line is added
  ...
  Scenario:
    ...
    Then the quantity received for product "56e1bb3a-33cc-4011-987c-d5c355609f1d" should be 2
    And the quantity received for product "c907a010-1e86-4a15-92c5-b0420c95d3c7" should be 2
